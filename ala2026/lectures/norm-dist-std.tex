...
\begin{frame}\FrameTitle{Standard Deviation}{Unit 1}
    ...
    \[
        \begin{array}{rll}
            ...
            &=& \dfrac{\lVert\,\MVec{x} - (\MVec{1}^{\Trans} \, \MVec{x}/{n}) \, \MVec{1}\,\rVert}{\sqrt{n}}
        \end{array}
    \]
\end{frame}
...
\begin{frame}\FrameTitle{Standard Deviation}{Unit 1}
    ...
    \vspace*{2em}
    The standard deviation of a vector $\MVec{x}$ tells us the typical
    amount by which its entries deviate from their average value.
\end{frame}
